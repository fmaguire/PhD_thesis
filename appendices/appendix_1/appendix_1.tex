...
avg / total    &      0.96    &  0.96  &    0.95  & 1728 \\
 \hline
 \end{tabular}
 \caption{KNeighborsClassifier(algorithm='auto', leaf\_size=30, metric='minkowski',
...
avg / total    &      0.92    &  0.92  &    0.92 & 1728 \\
 \hline
 \end{tabular}
 \caption{ExtraTreeClassifier(class\_weight=None, criterion='gini', max\_depth=None,
...
avg / total    &      0.58    &  0.47  &    0.38  & 1728 \\
 \hline
 \end{tabular}
 \caption{LDA(n\_components=None, priors=None, shrinkage=None, solver='svd',
...
avg / total    &      0.73 &  0.73 &    0.65  & 1728 \\
 \hline
 \end{tabular}
 \caption{QDA(priors=None, reg\_param=0.0)}
\end{table}
...
avg / total    &      0.93 &  0.92 &    0.91 & 1728 \\
 \hline
 \end{tabular}
 \caption{LogisticRegression(C=1.0, class\_weight=None, dual=False, fit\_intercept=True,
