...
endosymbiosis can be investigated. This endosymbiosis enables phototrophy in the host \citep{Karakashian1963} as well as 
the numerous photobiological behavioural and biochemical traits (e.g. \citep{Berk1991,Saji1974,Nakajima1989,Niess1982a,Iwatsuki1988,Summerer2009}, partially reviewed in \citep{Sommaruga2009}).
Additionally, there is experimental evidence as to the importance of photosynthesis and unidentified light-induced factors for the establishment
...
identify key transcripts likely to be involved in the establishment and maintenance of this endosymbiosis as well as those related to
mechanisms of the acquired photobiological traits.
%constitutively expressed photosynthetic components
Such a profile will allow metabolic reconstruction of host and endosymbiont in both photosynthetically active and inactive
states as well as a means to identify significantly differentially expressed transcripts between these states.
...
Principally, these are the dual challenges of accurately reconstructing transcripts from a complex and genomically uncharacterised complex system and 
...
extracted RNA and maintainable culture density for sequencing it was necessary to pool all day and night replicates into 
a single pair of day and night libraries.  Therefore, to facilitate accurate inference of differential expression 
a number of day and night replicates were also sequenced using single-cell RNA-Seq (scRNA-Seq) methods in order to generate
independent biological replicates \citep{Auer2010}.  scRNA-Seq is a relatively new technology whose potential
in ``dual-RNAseq'' systems has been previously observed \citep{Westermann2012}.  Additionally, application of scRNA-Seq is relatively
new to non-model unicellular eukaryotes without genomic resources with only one currently published investigation \citep{Kolisko2014}.
