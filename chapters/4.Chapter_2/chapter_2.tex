...
However, sequenced genomes for other divergent ciliates (i.e. \textit{Tetrahymena thermophila} \citep{Eisen2006} and \textit{Paramecium tetaurelia}
\citep{Aury2006}) and for fairly closely related algae \textit{Chlorella variabilis} NC64A \citep{Blanc2010} and \textit{Coccomyxa subellipsoidea} C-169 \citep{Blanc2012}
(see \ref{fig:introduction} and \ref{fig:introduction}), which could potentially aid transcriptome assembly.  
