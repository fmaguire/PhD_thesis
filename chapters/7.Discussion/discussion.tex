...
Testing this could be achieved
...
number of the endosymbionts.  The difficulty in this would optimising
...
As the previously established \textit{Paramecium}.
...
and CCAP 1660/13 cultures revealed that these cultures contained
the same \textit{M. reisseri} endosymbiont and not a \textit{Coccomyxa}
endosymbiont as labelled. The identity of the Yad1g1N endosymbiont
...
unique traits.  Specifically, \textit{M. reisseri} has lost
...
diversity of the systems discovered in the 4 \textit{P. bursaria}-algal endosymbioses
