...
deeper complications beneath. Nature is anything but simple.
    \qauthor{- Richard Preston: \textit{The Hot Zone}, 1994}
\end{savequote}
...
RNA precursors are likely processed
...
\begin{figure}
    \includegraphics{l4440_vector.pdf}
...
\begin{table}
    ...
    \textbf{Gene} & \textbf{Function} & \textbf{RNAi phenotype in}      & Vector Design & Reference \\
        ...
        \hline
        \textit{epi2} & Epiplasmin & ``Monstrous'' cells  & \SI{500}{\bp} via \textit{Pst}I and \textit{Hind}III & \citep{Damaj2009} \\
        NSF & Membrane fusion factor & Lethal & \SI{500}{\bp} via \textit{Pst}I and \textit{Hind}III & \citep{Galvani2002} \\
        pTMB.422c & Binding protein & Lethal & \SI{500}{\bp} via \textit{Pst}I and \textit{Hind}III & \citep{Nowack2011} \\
        \textit{bug22} & Basal body/ciliary protein & Slow swimming and death & \SI{313}{\bp} via \textit{Xba}I and \textit{Hind}III & \citep{Laligne2010} \\
        BBS7 & Ciliary ion transport & Fewer, shorter cilia & \SI{486}{\bp} via \textit{Xho}I and \textit{Hind}III & \citep{Valentine2012} \\
        PGM & PGM endonuclease & Post-autogamous cells unable to resume normal growth & \SI{500}{\bp} via \textit{Pst}I and \textit{Hind}III & \citep{Baudry2009} \\
        \hline
\end{tabular}}
    \caption[RNAi vectors and inserts used]{Details of RNAi vectors used in dsRNA experiments.  
...
Bacterial pre-cultures were started using a single colony picked from an LB
...
but only tested the PGM and epi2 constructss.
...
The Rdr3 analysis didn't identify any hits in the \textit{T. thermophila}
