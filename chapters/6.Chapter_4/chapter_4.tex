...
Interestingly, the 3 ciliate species displayed a generally low number of collisions 
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{consistency_unique_coll.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{host_endosymbiont_collisions.pdf}
...
pathway (Psd1) and depending on the function of a putative ancestral
...
clade does not recapitulate the 3 established WGD events in this group.
