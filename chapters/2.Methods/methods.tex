...
Yad1g1N host is mating type 1 and was created by mixing of isolated and cultured endosymbiont (\textit{Chlorella variabilis} Clone 1 (known as 1N strain)
...
the cellular community composition of marine micro-eukaryotes \citep{}<++> %BIOMARKS PAPER.
...
as much \texit{a priori} knowledge of a specific organism or environment as a targeted approach.
...
Epistemological crisis in genomics \citep{Dougherty2008} %go back to this paper
...
% figure showing regression vs classification side-by-side
