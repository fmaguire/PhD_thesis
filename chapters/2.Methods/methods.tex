...
studies suggesting the optimal apporach is permissive trimming (e.g. \(q \geq 2\)) 
...
for this is that of the concomitably variable codon or ``covarion'' model \citep{Penny2001}.
