...
\begin{itemize}
    ...
    \item Paramecium bursaria - history, biology, importance a 
\end{itemize}
...
living together (``sym/σύν'' - together, ``bios/βίωσις'') of two different 
organisms to a point of mutual benefit \citep{DeBary1879,Pound1893}, in which one species is internal 
(``endo/ἔνδον'') 
.  Specifically, it is typically
...
Development of a formal endosymbiotic theory for organellar origin was a process that
...
through to the extension of this
