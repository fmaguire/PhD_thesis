...
\includegraphics[width=\textwidth]{PBMR_pics.pdf}
    \caption[Light and Fluorescent Microscope Images of PbMr]{
        \textbf{A}: Composite fluorescence overlay of \textit{Paramecium bursaria} CCAP 1660/12 captured on <++> STEPHANOS. \textbf{B, D, and E}: Greyscale light and 
        chlorophyll fluorescence images of \textit{P. bursaria} CCAP 1660/12 captured on
        <++> KEN'S.  \textbf{C}: Composite overlay of CCAP 1660/12 captured on <++> ANDY FOSTER.
