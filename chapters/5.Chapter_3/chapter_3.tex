...
\begin{figure}
    \centering
    \includegraphics{endosymbiont_bin_annotation.pdf}
...
\begin{figure}
    \centering
    \includegraphics{endo_distribution_of_top_BLAST_hits.pdf}
...
\begin{figure}
    \centering
    \includegraphics{endosymbiont_bin_size_dist.pdf}
    \caption{asdasd}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics{LCMS_pos_down_metabolites.pdf}
...
\begin{figure}
    \centering
    \includegraphics{LCMS_pos_up_metabolites.pdf}
    \caption{Of the 254 positive significantly different present metabolites,
        19 were removed after manual inspection of peaks, 95 were removed due
    to having no METLIN hits}
    \label{fig:posqtofup}
...
\begin{figure}
    \centering
    \includegraphics{LCMS_neg_metabolites.pdf}
