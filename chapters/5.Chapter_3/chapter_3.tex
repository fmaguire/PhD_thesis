...
Therefore, I will briefly review the current state of knowledge of
...
\subsubsection{Nitrogen Metabolism}
...
%
%\(Ca_2^{+}\) and \(Mg_2^{+}\) inhibit affects amino acid uptake \citep{Kato2008} in
%the general amino acid transporters of \textit{C. vulgaris} and F36-ZK 
%
...
%GCMS- down reg of putative 6-Acetly-D-glucose -1.24
%
%
...
and significantly down-regulated Raffinose. 
