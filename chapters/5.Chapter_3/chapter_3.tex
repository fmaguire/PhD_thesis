...
step and reataining all proteins predicted to be extracellular or have a signal
...
Following this, reads were error-corrected using SEECER w
ith a \(k\)-mer size of 25 and 
...
the majority of the predicted proetome is surprising.
