...
Furtherstudies should confirm the identity of these proteins using
...
using approaches like recursive
neural network models, specifically long-short term memory networks 
