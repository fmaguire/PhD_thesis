...
Redutase (NiR) in the two \textit{C. variabilis} strains \citep{Kato2009a}. 
...
organellar related transporters such as cytochrome system and photosystems
...
bulk RNAseq transcriptome of \textit{Paramecium bursaria} YADG1N (syngen
...
retention time suggests that GC could be recalibrated to optimise
...
\begin{figure}
    ...
    \caption[LCQTOF Cloud Plots]{LCQTOF Cloud Plots demonstrating
...
Several amino acids and olgiopeptides were identified as significantly
up and down regulated in the LCQTOF analyses. However,
...
The relatively massive Arginine concentration as well as signficant
...
Additionally, the unique presence of lysine, glutamine and D-glutamte 
...
unlikely that EGT has occurred between host and endosymbbiont as extensively
...
individually using localisation and (q)PCR based anaylses.
