...
These form at least 4 distinct species groups, believed to be represented
...
Unfortunately, difficulties recovering and binning genomic
contigs prevented a comprehensive analysis of genomic
variation. 
...
This was to ensure lysis of the endosymbiont chitin cell wall.
...
\begin{figure}
    \includegraphics[height=\textheight,width=\textwidth]{its_phylo.pdf}
...
All elimination analysis focused on the \textit{P. bursaria}-\textit{M. reisseri}
CCAP 1660/12 strain.
...
Unfortunately, this lead to the same process of gradual bleaching of the CCAP 
1660/12 cultures followed by their depth. The difference being at the lower concentration
...
variation within a single clonal population.
